...
import Resume from '../assets/Web Dev Updated Resume as of Dec 2022.pdf';
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0 z-10'>
        <ul>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]'>
            <a className='flex justify-between items-center w-full text-white' href={Resume} target="_blank">
